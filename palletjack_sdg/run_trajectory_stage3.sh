...
#   ./run_trajectory_stage3.sh --num_frames 10 --headless False
#   ./run_trajectory_stage3.sh --num_frames 30 --data_dir /path/to/output
...
DATA_DIR="$SCRIPT_DIR/palletjack_data/trajectory_stage3"
...
echo "Starting trajectory stage-3 SDG"
