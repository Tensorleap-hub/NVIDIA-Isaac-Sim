...
#   ./run_trajectory_stage6.sh --num_frames 10
#   ./run_trajectory_stage6.sh --num_frames 60 --headless False
...
DATA_DIR="$SCRIPT_DIR/palletjack_data/trajectory"
...
echo "Starting trajectory stage-6 SDG (Carter robot + occupancy path)"
