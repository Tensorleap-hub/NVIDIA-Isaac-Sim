...
def discover_base_rgb_images(base_root: Path) -> list[Path]:
    ...
    if not rgb_dirs:
        raise ValueError(f"No Camera/rgb directories found under {base_root}")
...
def main() -> int:
    ...
    html_path = output_dir / "population_pca.html"
    csv_path = output_dir / "run_performance.csv"
    points_path = output_dir / "population_points.csv"
